...
export interface WorkspaceSnapshot {
  ...
  assets:Asset[]; liabilities:Liability[]; scenarios:ScenarioRecord[]; investmentComparison?:InvestmentComparisonRecord|null; retirementPlan?:RetirementPlanRecord|null;
}
...
export interface Repository {
  ...
  updateRetirementPlan?(input:Omit<RetirementPlanRecord,"revision"|"householdId">&{expectedRevision:number}):Promise<RetirementPlanRecord>;
