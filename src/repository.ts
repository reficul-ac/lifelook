...
export interface RecurringEntry { id:string; householdId:string; categoryId:string; accountId?:string|null; name:string; amountCents:number; frequency:RecurringFrequency; incomeType?:"ordinary"|"salary"; incomeTaxCategory?:import("./domain/types").IncomeTaxCategory; ownerPersonId?:string|null; startDate:string; endDate?:string|null; annualGrowthBps:number; annualGrowthMonth?:number|null; annualGrowthCapCents?:number|null; taxTreatment?:"none"|"pretax"; revision:number }
...
export interface AssetInput { id:string;name:string;valueCents:number;annualGrowthBps:number;appreciationCurve?:AppreciationCurve|null;privateStock?:PrivateStockVesting|null;equityHolding?:import("./domain/types").EquityHolding|null;housingCosts?:import("./domain/types").HousingCosts;purchasePriceCents?:number|null;purchaseDate?:string|null;homeSaleAssumptions?:import("./domain/types").HomeSaleAssumptions|null;taxableCostBasisCents?:number|null;rentalTaxBasisCents?:number|null;rentalBuildingBasisCents?:number|null }
...
export interface WorkspaceSnapshot {
  ...
  assets:Asset[]; liabilities:Liability[]; scenarios:ScenarioRecord[]; investmentComparison?:InvestmentComparisonRecord|null; retirementPlan?:RetirementSettingsRecord|null;
}
