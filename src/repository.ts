...
export interface RecurringEntry { id:string; householdId:string; categoryId:string; accountId?:string|null; name:string; amountCents:number; frequency:RecurringFrequency; incomeType?:"ordinary"|"salary"; startDate:string; endDate?:string|null; annualGrowthBps:number; taxTreatment?:"none"|"pretax"; revision:number }
export interface RecurringInput { id:string;categoryId:string;accountId?:string|null;name:string;amountCents:number;frequency:RecurringFrequency;incomeType?:"ordinary"|"salary";startDate:string;endDate?:string|null;annualGrowthBps:number;taxTreatment?:"none"|"pretax" }
